    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autores', models.ManyToManyField(to='PruebaModelos.autor')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favoritos', to='PruebaModelos.libro'),
        ),
        migrations.CreateModel(
            name='Prestamos',
            fields=[
        ...
        migrations.AddField(
            model_name='cliente',
            name='libros',
            field=models.ManyToManyField(related_name='libros', through='PruebaModelos.Prestamos', to='PruebaModelos.libro'),
        ),
    ]
